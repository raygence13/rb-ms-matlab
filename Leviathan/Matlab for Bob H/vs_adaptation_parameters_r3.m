function ap = vs_adaptation_parameters_r3(EST)
%
% 19 October 2010
...
ap.c = 1440;
ap.rho = 1;
ap.accel_sens = 3.5; % acceleration sensitivity
ap.hyd_sens = -158; % dB//1V/1microPa
...
%% BPF characteristics (recall that the signals that we used in the
% Stillwater Oct 2009 test had most of the energy in this band)
ap.fll = 2300;
ap.fhh = 4000;
ap.bw = ap.fhh - ap.fll;
...
%% Thresholds
ap.front_back_threshold_db = 4; % Front to back threshold
ap.LOS_rate_threshold_db = 1; % Additional threshold for LOS rate calculation
...
pitch_delta_degs = 2.6;%2.5;%2.5;
roll_delta_degs = -14;%13;%13;
